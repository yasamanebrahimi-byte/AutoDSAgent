...
These figures were generated by a real end-to-end run using the bundled synthetic customer-churn dataset and target `churn`.

### Inspect target balance

![Churn target class distribution generated by AutoDS Agent](docs/screenshots/target-distribution.png)
