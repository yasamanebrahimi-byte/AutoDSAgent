...
def evaluation_summary_payload(run_id: str) -> dict:
    return {
        ...
        "primary_metric": "f1",
        "best_model_name": "logistic_regression",
        "baseline_metrics": {"accuracy": 0.5, "precision": 0.25, "recall": 0.5, "f1": 0.3333},
        "best_model_metrics": {"accuracy": 1.0, "precision": 1.0, "recall": 1.0, "f1": 1.0},
        "all_model_metrics": {
            "baseline_most_frequent": {"accuracy": 0.5, "f1": 0.3333},
            "logistic_regression": {"accuracy": 1.0, "f1": 1.0},
        },
        "baseline_comparison": {
            "absolute_improvement": 0.6667,
            "percent_improvement": 200.0,
            "interpretation": "The best candidate improved on the baseline with a higher f1.",
        },
        "generated_plots": [
            {
