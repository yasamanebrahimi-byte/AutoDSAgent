...
- Repository commit: `90a09f252022755a592157f2b37ef812703b57d5`.
...
- All operational trials: soft agreement **16.7%**, soft disagreement **83.3%**.
- Model-family disagreement rate: **83.3%**; preprocessing disagreement rate: **16.7%**.
- OpenAI-only method agreement: **n/a**; preprocessing agreement: **n/a**.

| Method distribution | Initial agent | Gated final |
|---|---|---|
| All trials | {'regularized_linear': {'count': 5, 'rate': 0.8333333333333334}, 'tree_ensemble': {'count': 1, 'rate': 0.16666666666666666}} | {'linear': {'count': 4, 'rate': 1.0}} |
| OpenAI only | {} | {} |

## Empirical Reference Comparison

- All operational trials: initial reference match **0.0%**; gated reference match **75.0%**.
...
- Operational outcomes: improved **0**, worsened **0**, tie **4**.
...
- Total disagreements: **4**; challenges: **4**; abstentions: **0**.
- Challenge rate: **100.0%**; abstention rate: **0.0%**.
- Soft-challenge reconciliation invocation rate: **100.0%**.
- Reconciliation invocation rate: **83.3%**; success rate: **80.0%**.
- Sided with agent: **0.0%**; sided with deterministic challenger: **100.0%**.
- Soft-challenge outcomes: **0 improved**, **0 worsened**, **4 neutral**.
- Challenge outcomes: **0 improved**, **0 worsened**, **4 neutral**; intervention precision: **n/a**.
- Abstentions where agent was better: **0**; where deterministic was better: **0**.
- Mean challenge regret improvement: **0.0013**; unnecessary interventions: **0** (**0.0%**).
...
|---|---:|---:|---:|---|---:|
| unsafe_perturbation | 0 | n/a | n/a | 0 / 0 / 0 | n/a |

## Validation / Safety Interceptions

- Initial hard-invalid proposals: **2**; hard-validation interventions: **2**; interception rate: **100.0%**.
- Final hard-invalid trials: **2**; validation failure codes: `{'classification_split_and_stratification_feasible': 1, 'classification_training_supports_cross_validation': 1, 'no_direct_target_copy_features': 1}`.
...
- Intentionally unsafe perturbations intercepted: **2** / **5** perturbation trials where applicable.
