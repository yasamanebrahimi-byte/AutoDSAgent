...
- Evidence: <code>["target_column=target", "target_source=inferred", "target_dtype=object", "target_semantic_type=categorical", "valid_target_rows=80", "unique_values=2", "unique_value_fraction=0.0250", "numeric_or_coercible_fraction=0.0000", "model_selection_diagnostics_not_used"]</code>
