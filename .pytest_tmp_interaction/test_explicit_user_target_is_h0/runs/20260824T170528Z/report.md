...
- Reasoning: The formulation proposal uses the question and compact schema evidence only. Explicit user target constraint enforced by deterministic guardrail.
...
- Evidence: <code>["target_column=diagnosis", "target_source=user_supplied", "target_dtype=object", "target_semantic_type=categorical", "valid_target_rows=64", "unique_values=2", "unique_value_fraction=0.0312", "numeric_or_coercible_fraction=0.0000", "model_selection_diagnostics_not_used"]</code>
