...
Probe invoked: <code>{validation.get('empirical_probe_invoked', False)}</code>; status: <code>{validation.get('probe_status', empirical_probe.get('status', 'not invoked'))}</code>; policy: <code>{empirical_probe.get('policy_version', 'not invoked')}</code>; metric: <code>{empirical_probe.get('metric', 'not invoked')}</code>; folds: <code>{empirical_probe.get('cv_folds', 'not invoked')}</code>; winner: <code>{empirical_probe.get('winner', 'not invoked')}</code>; evidence strength: <code>{validation.get('probe_evidence_strength', empirical_probe.get('evidence_strength', 'not invoked'))}</code>; abstention reason: <code>{validation.get('abstention_reason', 'none')}</code>.
