...
def render_summary_markdown(
    ...
    rows = [
        ...
        f"| Descriptive pooled paper holdout delta | {_number(summary.get('dataset_macro_paper_holdout_delta_mean'))} | {_number(summary.get('paper_holdout_delta_mean'))} |",
        "",
