...
def render_summary_markdown(
    ...
    rows = [
        ...
        f"- Intervention precision: **{_percent(summary.get('intervention_precision'))}**; challenge yield: **{_percent(summary.get('challenge_yield'))}**; harm rate: **{_percent(summary.get('harm_rate', summary.get('harmful_intervention_rate')))}**; unnecessary-intervention rate: **{_percent(summary.get('unnecessary_intervention_rate'))}**.",
        ...
        f"- Paper holdout delta (dataset-macro mean): **{_number(summary.get('dataset_macro_paper_holdout_delta_mean'))}**; median: **{_number(summary.get('dataset_macro_paper_holdout_delta_median'))}**; clustered CI: `{summary.get('dataset_macro_paper_holdout_delta_ci')}`.",
        "",
        ...
        f"| Harmful-intervention rate | {_percent(summary.get('dataset_macro_gate_health', {}).get('harmful_intervention_rate', summary.get('harmful_intervention_rate')))} | {_percent(summary.get('trial_weighted_gate_health', {}).get('harmful_intervention_rate'))} |",
        ...
        f"| Paper holdout delta | {_number(summary.get('dataset_macro_paper_holdout_delta_mean'))} | {_number(summary.get('paper_holdout_delta_mean'))} |",
        "",
    ...
    rows.extend([
        ...
        f"- OpenAI-only mean paired paper holdout delta: **{_number(openai_pair.get('mean_paired_holdout_improvement'))}** (dimensionless; subgroup descriptive).",
