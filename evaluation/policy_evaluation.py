...
def render_final_report(artifact: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- Intervention precision: `{aggregate.get('intervention_precision')}`; training-reference challenge yield: `{aggregate.get('training_reference_challenge_yield', aggregate.get('challenge_yield'))}`; training-reference harmful rate: `{aggregate.get('training_reference_harmful_intervention_rate')}`",
        f"- Challenge recall: `{aggregate.get('challenge_recall')}`; training-reference unnecessary rate: `{aggregate.get('training_reference_unnecessary_intervention_rate', aggregate.get('unnecessary_intervention_rate'))}`",
