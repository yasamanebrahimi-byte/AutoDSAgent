...
|---|---|---|
| All trials | {'tree_ensemble': {'count': 1, 'rate': 1.0}} | {'tree_ensemble': {'count': 1, 'rate': 1.0}} |
| OpenAI only | {} | {} |

## Empirical Reference Comparison

- All operational trials: initial reference match **0.0%**; gated reference match **0.0%**.
...
- Total disagreements: **1**; challenges: **1**; abstentions: **0**.
...
- Soft-challenge outcomes: **0 improved**, **0 worsened**, **1 neutral**.
- Challenge outcomes: **0 improved**, **0 worsened**, **1 neutral**; intervention precision: **n/a**.
...
|---|---:|---:|---:|---|---:|
| agent_wins_soft_challenge | 0 | n/a | n/a | 0 / 0 / 0 | n/a |
