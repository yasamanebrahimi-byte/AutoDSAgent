...
|---|---|---|
| All trials | {'linear': {'count': 1, 'rate': 1.0}} | {} |
| OpenAI only | {} | {} |

## Empirical Reference Comparison

- All operational trials: initial reference match **100.0%**; gated reference match **n/a**.
...
- Reconciliation invocation rate: **100.0%**; success rate: **0.0%**.
...
|---|---:|---:|---:|---|---:|
| preprocessing_disagreement | 0 | n/a | n/a | 0 / 0 / 0 | n/a |

## Validation / Safety Interceptions

- Initial hard-invalid proposals: **1**; hard-validation interventions: **1**; interception rate: **100.0%**.
- Final hard-invalid trials: **1**; validation failure codes: `{'linear_numeric_features_use_approved_scaling_policy': 1, 'reconciliation_justification_discusses_preprocessing': 1}`.
