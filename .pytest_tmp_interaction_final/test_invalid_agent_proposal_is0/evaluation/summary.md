...
- Model-family disagreement rate: **0.0%**; preprocessing disagreement rate: **100.0%**.
- OpenAI-only method agreement: **n/a**; preprocessing agreement: **n/a**.

| Method distribution | Initial agent | Gated final |
|---|---|---|
| All trials | {'linear': {'count': 1, 'rate': 1.0}} | {'linear': {'count': 1, 'rate': 1.0}} |
| OpenAI only | {} | {} |
...
- Operational outcomes: improved **0**, worsened **0**, tie **0**.
...
- Total disagreements: **1**; challenges: **0**; abstentions: **0**.
- Challenge rate: **0.0%**; abstention rate: **0.0%**.
...
|---|---:|---:|---:|---|---:|
| invalid_agent | 0 | n/a | n/a | 0 / 0 / 0 | n/a |

## Validation / Safety Interceptions

- Initial hard-invalid proposals: **1**; hard-validation interventions: **1**; interception rate: **100.0%**.
- Final hard-invalid trials: **0**; validation failure codes: `{'numeric_missing_values_are_handled': 1}`.
