...
DATASET = Path(r"C:\Users\19492\Desktop\AutoDSAgent\.pytest_tmp_interaction_final\test_explicit_user_target_is_h0\fixture.csv")
RUN_DIR = Path(__file__).resolve().parent
TARGET = 'diagnosis'
QUESTION = 'Classify diagnosis from the measured features.'
METHOD = 'linear'
