...
- <code>nonlinearity</code> (+5): nonlinearity score 0.09 is low
- <code>structural_complexity</code> (+2): structural complexity score 0.04 suggests heterogeneous or nonlinear feature relationships
