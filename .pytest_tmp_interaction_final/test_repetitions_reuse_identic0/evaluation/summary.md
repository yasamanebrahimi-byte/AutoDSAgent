...
- Base seed: **19**; holdout fraction: **0.2**.
...
- All operational trials: soft agreement **0.0%**, soft disagreement **100.0%**.
- Model-family disagreement rate: **100.0%**; preprocessing disagreement rate: **0.0%**.
- OpenAI-only method agreement: **n/a**; preprocessing agreement: **n/a**.

| Method distribution | Initial agent | Gated final |
|---|---|---|
| All trials | {'regularized_linear': {'count': 3, 'rate': 1.0}} | {'linear': {'count': 3, 'rate': 1.0}} |
| OpenAI only | {} | {} |

## Empirical Reference Comparison

- All operational trials: initial reference match **0.0%**; gated reference match **100.0%**.
...
- Operational outcomes: improved **0**, worsened **0**, tie **3**.
...
- Total disagreements: **3**; challenges: **3**; abstentions: **0**.
- Challenge rate: **100.0%**; abstention rate: **0.0%**.
- Soft-challenge reconciliation invocation rate: **100.0%**.
- Reconciliation invocation rate: **100.0%**; success rate: **100.0%**.
- Sided with agent: **0.0%**; sided with deterministic challenger: **100.0%**.
- Soft-challenge outcomes: **0 improved**, **0 worsened**, **3 neutral**.
- Challenge outcomes: **0 improved**, **0 worsened**, **3 neutral**; intervention precision: **n/a**.
- Abstentions where agent was better: **0**; where deterministic was better: **0**.
- Mean challenge regret improvement: **0.0000**; unnecessary interventions: **0** (**0.0%**).
...
|---|---:|---:|---:|---|---:|
| research_fixture | 0 | n/a | n/a | 0 / 0 / 0 | n/a |
